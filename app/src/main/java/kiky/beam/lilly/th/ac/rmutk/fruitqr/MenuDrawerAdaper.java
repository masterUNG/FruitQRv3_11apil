...
public class MenuDrawerAdaper extends RecyclerView.Adapter<MenuDrawerAdaper.MenuDrawerViewHolder> {
    ...
    public MenuDrawerAdaper(Context context, ArrayList<Integer> integerArrayList, ArrayList<String> stringArrayList, OnClickItem onClickItem) {
